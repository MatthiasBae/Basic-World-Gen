...
public class ChunkProcessorTaskEntityDespawn : ChunkProcessorTaskBase {
    
    public ChunkProcessorTaskEntityDespawn(Dictionary<Vector2I, Chunk> chunks) : base(chunks) { }
