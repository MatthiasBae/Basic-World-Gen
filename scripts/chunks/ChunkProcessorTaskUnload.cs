...
public class ChunkProcessorTaskUnload : ChunkProcessorTaskBase {
    
    public ChunkProcessorTaskUnload(Dictionary<Vector2I, Chunk> chunks) : base(chunks) { }
    ...
    public override void ProcessChunk(Chunk chunk) {
        //Not really necessary to unload at the moment
    }
}